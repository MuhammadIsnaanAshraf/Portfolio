...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Web Development",
      description: "A fully functional, responsive MERN stack application featuring the MVC architecture and REST APIs, .",
      // created: "5 Dec 2020",
      technologies: [
        "JavaScript",
        "React",
  ...
  return (
    <>
      <div className={`min-h-[100vh] py-10  ${isOpen && " overflow-y-hidden"}`}>
        ...
        {/* <div> */}
        <div className="flex sm:flex-row flex-col items-center justify-center gap-y-8 md:gap-x-16 sm:gap-x-8 gap-x-4 mt-22 w-full  mx-auto flex-wrap">
          
          {projects.slice(0, 4).map((project, index) => (
            <>
              <div key={index} className="box-border flex flex-col gap-y-1 border shadow shadow-cyan-300 sm:w-1/3 sm:mx-0 mx-6  bg-gray-900 p-4 rounded-sm">
                <div className="image w-full h-[80%]  rounded-sm">
                  <img
                    src={project.images}
                ...
                >
                  <p
                    onClick={() =>{ setIsOpen(true), setProject(project)}}
